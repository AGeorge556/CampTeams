        ...
        <div className="flex items-center justify-between">
          ...
          <div className="flex items-center space-x-3">
            <div className="text-center">
              <div className="text-lg font-bold text-[var(--color-primary)]">{countdown.days}</div>
              <div className="text-xs text-[var(--color-text-muted)]">{t('daysRemaining')}</div>
            </div>
            <div className="text-center">
              <div className="text-lg font-bold text-[var(--color-primary)]">{countdown.hours}</div>
              <div className="text-xs text-[var(--color-text-muted)]">{t('hoursRemaining')}</div>
            </div>
            <div className="text-center">
              <div className="text-lg font-bold text-[var(--color-primary)]">{countdown.minutes}</div>
              <div className="text-xs text-[var(--color-text-muted)]">{t('minutesRemaining')}</div>
            </div>
            <div className="text-center">
              <div className="text-lg font-bold text-[var(--color-primary)]">{countdown.seconds}</div>
    ...
    <div className="bg-[var(--color-bg-muted)] rounded-lg p-6 border border-[var(--color-border)]">
      ...
      <div className="grid grid-cols-4 gap-3">
        <div className="bg-[var(--color-card-bg)] rounded-lg p-3 shadow-sm border border-[var(--color-border)]">
          <div className="text-2xl font-bold text-[var(--color-primary)]">{countdown.days}</div>
          <div className="text-xs text-[var(--color-text-muted)]">{t('daysRemaining')}</div>
        </div>
        <div className="bg-[var(--color-card-bg)] rounded-lg p-3 shadow-sm border border-[var(--color-border)]">
          <div className="text-2xl font-bold text-[var(--color-primary)]">{countdown.hours}</div>
          <div className="text-xs text-[var(--color-text-muted)]">{t('hoursRemaining')}</div>
        </div>
        <div className="bg-[var(--color-card-bg)] rounded-lg p-3 shadow-sm border border-[var(--color-border)]">
          <div className="text-2xl font-bold text-[var(--color-primary)]">{countdown.minutes}</div>
          <div className="text-xs text-[var(--color-text-muted)]">{t('minutesRemaining')}</div>
        </div>
        <div className="bg-[var(--color-card-bg)] rounded-lg p-3 shadow-sm border border-[var(--color-border)]">
          <div className="text-2xl font-bold text-[var(--color-primary)]">{countdown.seconds}</div>
          <div className="text-xs text-[var(--color-text-muted)]">{t('secondsRemaining')}</div>
        </div>
      </div>
