        ...
        <div className="flex flex-col md:flex-row md:items-center md:justify-between mb-4 space-y-4 md:space-y-0">
          ...
          <div className="flex justify-center md:justify-end">
            <button
              ...
              className="inline-flex items-center px-4 py-3 md:px-4 md:py-2 border border-transparent text-sm font-medium rounded-md text-white bg-[var(--color-primary)] hover:opacity-90 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-orange-400 disabled:opacity-50 transition-colors duration-200"
            >
              {creatingSessions ? (
                  ...
                  <div className="flex-1 min-w-0">
                    <div className="flex flex-col sm:flex-row sm:items-center space-y-2 sm:space-y-0 sm:space-x-3">
                      <input
                        ...
                        className="h-5 w-5 text-[var(--color-primary)] border-gray-300 rounded focus:ring-orange-400"
