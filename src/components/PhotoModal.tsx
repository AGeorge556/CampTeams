    ...
    <div className="fixed inset-0 bg-black bg-opacity-90 flex items-center justify-center z-50 p-4">
      <div className="relative max-w-4xl max-h-full w-full h-full flex flex-col">
        ...
        <div className="flex items-center justify-between p-4 bg-black bg-opacity-50 text-white">
          <h2 className="text-lg font-semibold">{t('photoPreview')}</h2>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            ...
            <div className="flex flex-col space-y-2">
              <div className="flex items-center space-x-2">
                ...
                <span className="text-sm text-gray-300">{t('uploadedBy')}: {photo.user_id}</span>
              </div>
              <div className="flex items-center space-x-2">
                <Calendar className="h-4 w-4" />
                <span className="text-sm text-gray-300">{t('submittedOn')}: {formatDate(photo.submitted_at)}</span>
              </div>
            </div>
          </div>
        </div>
