        ...
        <div className="bg-white rounded-lg shadow-lg p-8 space-y-8">
          ...
          <div className="space-y-4">
            ...
            <div className="grid md:grid-cols-2 gap-6">
              ...
              <div className="bg-orange-50 rounded-lg p-6 border border-orange-200">
                <div className="flex items-start space-x-3">
                  ...
                  <div>
                    <h3 className="text-lg font-semibold text-gray-900 mb-2">{t('respectForOthers')}</h3>
              ...
              <div className="bg-blue-50 rounded-lg p-6 border border-blue-200">
                <div className="flex items-start space-x-3">
                  ...
                  <div>
                    <h3 className="text-lg font-semibold text-gray-900 mb-2">{t('teamworkAndFairPlay')}</h3>
                    <ul className="text-gray-700 space-y-2 text-sm">
            ...
            <div className="bg-gray-50 rounded-lg p-6 border border-gray-200">
              <h3 className="text-lg font-semibold text-gray-900 mb-3">{t('additionalGuidelines')}</h3>
              <ul className="text-gray-700 space-y-2 text-sm">
