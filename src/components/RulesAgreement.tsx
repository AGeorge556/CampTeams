          ...
          <div className="flex items-start space-x-3">
            <div className="flex-shrink-0">
              <input
                ...
                className="w-6 h-6 sm:w-5 sm:h-5 text-orange-600 bg-[var(--color-input-bg)] border-[var(--color-border)] rounded focus:ring-orange-400 focus:ring-2 cursor-pointer"
              />
            </div>
