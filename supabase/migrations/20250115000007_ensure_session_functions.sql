-- Ensure all session creation functions are properly defined
-- This migration ensures the functions exist even if previous migrations failed
...
BEGIN
  IF NOT EXISTS (
    ...
    WHERE table_name = 'camp_sessions' AND column_name = 'schedule_id'
  ) THEN
