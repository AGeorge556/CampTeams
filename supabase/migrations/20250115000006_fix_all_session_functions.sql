-- Comprehensive fix for all session-related functions
-- This migration ensures all functions have consistent return types and column names

-- Drop all existing session functions to avoid conflicts
...
-- Recreate get_sessions_with_schedule with consistent return type
...
-- Recreate get_sessions_with_delays with consistent return type
...
-- Recreate get_sessions_with_attendance with consistent return type
...
-- Recreate get_attendance_with_users with consistent return type
